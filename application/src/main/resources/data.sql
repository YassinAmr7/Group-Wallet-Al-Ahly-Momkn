-- mySQL script to insert initial data into the users and wallets tables
...
--
--   INSERT INTO wallets (balance, type, user_id, group_id, version)
--   SELECT 5000.00, 'PERSONAL', 3, NULL, 0 FROM DUAL
--   WHERE NOT EXISTS (SELECT 1 FROM wallets WHERE user_id = 3 AND type = 'PERSONAL');
--
...
-- sql script to insert initial data into the users and wallets tables
--
--
